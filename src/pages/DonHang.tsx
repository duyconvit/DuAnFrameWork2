...
import { ShoppingCartOutlined, UserOutlined, BarChartOutlined, EditOutlined, LoginOutlined } from "@ant-design/icons";
...
const OrderManagement = () => {
  ...
  const updateStatus = async (id, status) => {
    try {
      ...
      // ✅ Cập nhật ngay state `orders` để phản ánh thay đổi
    ...
    <Layout style={{ minHeight: "100vh" }}>
      ...
      <Layout>
        ...
        <Content style={{ margin: "16px" }}>
          <Table columns={columns} dataSource={orders} rowKey="id" bordered pagination={{ pageSize: 20 }} />
        </Content>
      </Layout>
    </Layout>
  );
